...
#bindkey "^?" backward-kill-word                   # ctrl + bksp / ctrl + delete
...
alias zshrc-root='sudo cp ~/.zshrc /root'
...
# gitstatus
alias gitstatus-install='test ! -d ~/gitstatus && git clone --depth=1 https://github.com/romkatv/gitstatus.git ~/gitstatus && f5'
[ -f ~/gitstatus/gitstatus.prompt.zsh ] && source ~/gitstatus/gitstatus.prompt.zsh && configure_prompt
